...
public class RecipeStepsTest {
    ...
    public void clickedRecipeOpensCorrectDetailScreen() {
        ...
        onView(withId(R.id.recipe_steps_list)).perform(RecyclerViewActions.actionOnItemAtPosition(0, click()));

        matchToolbarTitle("Nutella Pie Steps").check(matches(isDisplayed()));
